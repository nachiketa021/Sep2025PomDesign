...
public class ProductInfoPage {
	...
	private final By productImages=By.cssSelector("div#content li img");
	...
	public Map<String,String> getProductData() {
		...
		productMap=new TreeMap<String, String>(); //sorted map with the key
		
	
		
		productMap.put("Product_Name", getProductHeader());
		productMap.put("Product_Images",String.valueOf(getProductImages()));
	...
	//$2,000.00
	//Ex Tax: $2,000.00
	private void getProductPticeData() {
